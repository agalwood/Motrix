...
download [v2.0.0-beta.37 from GitHub Releases](https://github.com/agalwood/Motrix/releases/tag/v2.0.0-beta.37)
and read the [full release notes](./docs/release-notes/2.0.0-beta.37.md) before
installing it.
...
export MOTRIX_IMAGE='docker.io/motrixapp/motrix-server:2.0.0-beta.37'
