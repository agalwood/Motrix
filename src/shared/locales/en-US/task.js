export default {
  ...
  "delete-task-confirm":
    'Are you sure you want to remove download task "{{taskName}}"?',
  "batch-delete-task-confirm":
    "Are you sure you want to remove {{count}} download tasks in batch?",
  ...
  "remove-task-file-fail":
    "Failed to delete task file(s), please delete them manually",
  "remove-task-config-file-fail":
    "Failed to delete task config file, please delete it manually",
  ...
  "remove-record-success":
    'Successfully removed task record for "{{taskName}}"',
