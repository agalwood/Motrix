export default {
  ...
  'batch-delete-task-confirm': 'آیا مطمئن هستید که می خواهید {{count}} کار بارگیری را به صورت دسته ای حذف کنید؟',
  ...
  'select-all-task': 'همه کارها را انتخاب کنید',
  ...
  'batch-delete-task-success': 'کارها را با موفقیت حذف کنید',
  'batch-delete-task-fail': 'انجام وظایف در دسته حذف نشد',
