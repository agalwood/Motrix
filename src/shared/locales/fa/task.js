export default {
  ...
  'new-bt-task': 'وظیفه بیت‌تورنت جدید',
  'open-file': 'بازکردن پروندهٔ تورنت...',
  'uri-task': 'آدرس اینترنتی',
  'torrent-task': 'تورنت',
  'uri-task-tips': 'یک آدرس در هر خط(از مگنت پشتیبانی میشود)',
  'thunder-link-tips': 'نکته: پیوند‌های تاندر ممکن هست بعد کدگشایی قابل بارگیری نباشند',
  'new-task-uris-required': 'لطفا حداقل یک آدرس معتبر وارد کنید',
  'new-task-torrent-required': 'لطفا یک پروندهٔ تورنت را انتخاب کنید',
  'file-name': 'نام',
  'file-extension': 'پسوند',
  'file-size': 'اندازه',
  'file-completed-size': 'تکمیل شده',
  'selected-files-sum': 'انتخاب شده: {{selectedFilesCount}} پرونده، اندازه کل {{selectedFilesTotalSize}}',
  'select-at-least-one': 'لطفا حداقل یک پرونده را انتخاب کنید',
  'task-name': 'نام وظیفه',
  'task-out': 'تغییرنام',
  ...
  'delete-selected-tasks': 'وظایف انتخاب شده را حذف کن',
  ...
  'remove-task-file-fail': 'حذف وظیفه(ها) شکست خورد، لطفا به صورت دستی حذفشان کنید',
  'remove-task-config-file-fail': 'حذف پرونده پیکربندی وظیفه شکست خورد، لطفا به صورت دستی حذفشان کنید',
  ...
  'select-torrent': 'پروندهٔ تورنت را اینجا بکشید، یا برای انتخاب کلیک کنید',
  ...
  'bt-stopping-seeding-tip': 'متوقف کردن بذرپاشی، قطع ارتباط مدتی طول خواهد کشید، لطفا صبر کنید ...',
