export default {
  ...
  'mas-default-dir-tip': 'بخاطر محدودیت‌های دسترسی سندباکس از اپ استور، پیشنهاد می‌شود فولدر دانلود پیشفرض ست شده باشد.',
  ...
  'browser-extensions-tip': 'تهیه شده توسط انجمن، ',
