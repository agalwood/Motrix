export default {
  ...
  'keep-seeding': 'کاشتن را تا هنگامی که به صورت دستی قطع نشده، ادامه بده',
  'seed-ratio': 'ضریب دانه',
  'seed-time': 'زمان دانه',
  'seed-time-unit': 'دقیقه',
  'task-manage': 'مدیریت وظایف',
  'max-concurrent-downloads': 'بیشینه وظایف فعال',
  'max-connection-per-server': 'بیشینه اتصال برای هر سرور',
  ...
  'no-proxy-input-tips': 'تنظیمات پروکسی را برای این میزبان‌ها و دامنه‌ها استفاده نکن، یکی در هر خط',
  'proxy-tips': 'مشاهده راهنمای پروکسی',
