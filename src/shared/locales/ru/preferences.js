export default {
  ...
  'continue': 'Продолжить',
  'check-integrity': 'Проверять существующие файлы и заново скачивать только повреждённые части (только BitTorrent и загрузки с контрольной суммой)',
  'allow-overwrite': 'Не останавливать задачу, если целевой файл уже существует',
