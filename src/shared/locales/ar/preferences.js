export default {
  ...
  'new-task-show-downloading': 'إظهار التنزيل تلقائيًا بعد إضافة التحميل',
  ...
  'port': 'منافذ الاستماع',
  'bt-port': 'منفذ BT للإستماع',
  'dht-port': 'منفذ DHT للإستماع',
  'security': 'الحماية',
  ...
  'download-session-path': 'مسار التنزيلات',
  'session-reset': 'إعادة التنزيل',
  'session-reset-confirm': 'هل أنت متأكد أنك تريد إعادة تنزيله؟',
