  ...
  return (
    <main className="flex min-h-0 flex-1 flex-col px-5 pt-4 pb-5 text-[#1d1d1f] dark:text-foreground">
      <section
        ...
        className="min-h-0 flex-1 overflow-y-auto rounded-xl border border-black/14 bg-white px-6 py-6 shadow-[0_1px_2px_rgba(0,0,0,0.02)] dark:border-border dark:bg-card dark:text-card-foreground"
      >
