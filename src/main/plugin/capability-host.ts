...
export interface ElectronCapabilityHostOptions {
  ...
  /** Path to user data dir; holds the libsodium `secrets.lockbox` key file. */
  userDataDir: string
...
export async function createElectronCapabilityHost(
  opts: ElectronCapabilityHostOptions
