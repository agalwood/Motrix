...
English | [简体中文](https://github.com/agalwood/Motrix/blob/v2.0.0-beta.24/docs/release-notes/2.0.0-beta.24.zh-CN.md)

Motrix 2.0.0-beta.24 strengthens BitTorrent and Magnet task identity, recovery,
...
| Docker Hub / GHCR | `linux/amd64`, `linux/arm64` | Immutable `2.0.0-beta.24` tag in both registries |
| Snap Store | — | Not published for this beta |

After every container gate passes, the versioned image references will be
`docker.io/motrixapp/motrix-server:2.0.0-beta.24` and
`ghcr.io/agalwood/motrix-server:2.0.0-beta.24`. See the
[Docker Server deployment guide](https://github.com/agalwood/Motrix/blob/v2.0.0-beta.24/docs/docker-server.md)
